      ...
      <Container className="flex flex-col ">
        ...
        <div className="flex items-center justify-center align-middle w-full ">
          <div className=" mb-8 mx-auto">
            {/* <h1 className="text-4xl font-bold leading-snug tracking-tight text-center text-gray-800  lg:leading-tight lg:text-6xl xl:leading-tight bg-custom-gradient bg-clip-text text-transparent">
        ...
        <h1 className="text-2xl md:text-3xl lg:text-5xl font-bold leading-snug tracking-tight text-center text-gray-800 lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
          <span className="squiggly-underline">Join the wait list</span>
        </h1>

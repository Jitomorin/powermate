    ...
    <div className="relative">
      <Container>
        <div className="flex flex-col lg-flex-row  max-w-screen-xl justify-between mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2 mt-8">
            <div>
              <Link
                href="/"
                className="flex items-center space-x-2 text-2xl font-semibold text-black dark:text-gray-100"
              >
                <Image
                  src="/img/powermate_logo.png"
                  alt="Powermate"
                  width="32"
                  height="32"
                  className="w-8"
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          Copyright © {new Date().getFullYear()} Powermate - Illustrations from{" "}
